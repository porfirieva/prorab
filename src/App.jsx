...
import MobileAppPage from "./simplePages/MobileAppPage";
        ...
        <div className="index_page">
            <AuthContextProvide>
                ...
                <ApplicationMobileProvide>
                    ...
                    <main className="main">
                        <Routes>
                            <Route path="/application" element={<MobileAppPage />}></Route>

                            {!localStorage.getItem("token") && <Route path="*" element={<LoginMain />}></Route>}
                                ...
                                <>
                                    ...
                                    {category.map((item) => (
                                        <Route
                                            ...
                                            element={<SpecialEquipCatalog h1={item.title} types={item.type} />}></Route>
                                    ))}
                                    <Route
                                        path="/cart/:id"
                                        element={<CartProduct onUserData={onUserData} getIdPage={getIdPage} />}
                                    />
