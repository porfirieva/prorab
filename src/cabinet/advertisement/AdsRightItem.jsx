...
const AdsRightItem = props => {
    const ctx = useContext(AuthContext);
    const [product, setProduct] = useState({});

    useEffect(() => {
        fetch(`https://cc19244api.tmweb.ru/object/${props.idItem}`,
            {
                headers: {
                        ...
                        <button className="edit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                ...
                                <path
                                    ...
                                    fill="#414253"/>
                                <path d="M15.9372 4.7467C15.7932 4.7467 15.6492 4.69195 15.5397 4.5817L13.4187 2.45995C13.199 2.2402 13.199 1.88395 13.4187 1.6642C13.6385 1.44445 13.9947 1.44445 14.2145 1.6642L16.3355 3.78595C16.5552 4.0057 16.5552 4.36195 16.3355 4.5817C16.2252 4.6912 16.0812 4.7467 15.9372 4.7467Z" fill="#414253"/>
                            </svg>
                            Редактировать
                        </button>
