                ...
                <div className="box">
                    <ul className="left">
                        <li className="li">
                            ...
                            <NavLink to="/userTerm" className="item">Пользовательское соглашение</NavLink>
                            <NavLink to="/privacy" className="item">Политика конфиденциальности</NavLink>
                            <span onClick={ctx.closeMobileAppModal} className="item">Мобильное приложение</span>
                            <NavLink to="charity" className="item">Благотворительность</NavLink>
                        </li>
                    </ul>
                    <div className="right">
