...
const HeaderTop = (props) => {
    ...
    const personalHeader =
        location.pathname.indexOf("/lc") > -1 ? (
                ...
                <div className="box">
                    <ul className="left">
                        <li className="li">
                            ...
                            <NavLink to="/administrant" className="item">
                                Информация для исполнителей
                            </NavLink>
                            <NavLink to="/executor" className="item">
                    ...
                    <div className="right">
                        <button className="city">
                            <p className={isActive ? "active" : null} onClick={toggleClass}>
                                <svg
                                ...
                                <span>{cityHtml ? cityHtml : "Город не выбран"}</span>
                            </p>
