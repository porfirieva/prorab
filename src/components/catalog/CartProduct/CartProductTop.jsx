...
const CartProductTop = props => {
    ...
    const MarkZero = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M22.0612 7.83071H22.057H15.5825L13.5794 1.63989C13.3467 0.919871 12.6788 0.432434 11.9255 0.432434C11.9255
        0.432434 11.9255 0.432434 11.925 0.432434C11.1717 0.432434 10.5042 0.920264 10.2711 1.64028L8.27061 7.83068H1.79362C1.03988
        7.83068 0.372342 8.31851 0.139228 9.03901C-0.0934951 9.75899 0.161726 10.5482 0.771527 10.9934L6.01199 14.8188L4.01109 21.0088C3.7784 21.7292
        4.03362 22.5184 4.64294 22.9636C4.94785 23.186 5.30665 23.2973 5.66548 23.2973C6.02431 23.2973 6.3831 23.1859 6.68799 22.9636L11.9281 19.1372L17.1703
        22.9635C17.4752 23.1859 17.8335 23.2972 18.1924 23.2972C18.5512 23.2972 18.91 23.1858 19.2149 22.9631C19.8247 22.5179 20.0795 21.7287 19.8463 21.0083L17.8433
       14.8171L23.0434 11.0194C23.4995 10.704 23.7984 10.1764 23.7984 9.57894C23.7984 8.61348 23.0217 7.83071 22.0612 7.83071Z" fill="#B0A9A9"/></svg>
            ...
            <div className="container">
                <div className="card__box">
                    <div className="card__img">
                        <img src={url + props.product.image} alt="" />

                        {props.user.mark !== null && <div className="rating">
                        ...
                        {props.product.mark === null && <div className="rating"> {MarkZero} </div>}

                        <button className="like" onClick={activeLike}>
                            <svg onClick={activeLike} xmlns="http://www.w3.org/2000/svg" width="19" height="16" viewBox="0 0 19 16" fill="none">
                                <path
                    ...
                    <div className="card__content">
                        ...
                        <p className="text">{props.product.about}</p>
                        <div className="radio_box">
                            <div className="radio">
                                <input type="radio" name="radio12" id="11212" defaultChecked />
                                <label htmlFor="11212">
                            ...
                            <div className="radio">
                                <input type="radio" id="21212" name="radio12" />
                                <label htmlFor="21212">
                    ...
                    <div className="card__right">
                        ...
                        <div className="person">
                            <h5 className="h5">арендодатель </h5>
                            <div className="person__box">
                                    {props.user.avatar === null ?
                                        <div className="person__img person__img__null">
                                            <img src='' alt="" />
                                        </div>
                                        :
                                        <div className="person__img">
                                            <img src={url + props.user.avatar} alt="" />
                                        </div>
                                    }
                        ...
                        <div className="btns">
                            <button className="btn1" onClick={ctx.contactsHandleModal}>Открыть контакты</button>
                            <button className="btn2" onClick={ctx.requestModal}>Подать заявку</button>
                        </div>
                    </div>
                </div>
            </div>
