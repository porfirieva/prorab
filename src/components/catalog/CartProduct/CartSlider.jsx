...
const CartSlider = props => {
    ...
    return(
        <>
        {lengthSimilar > 0 && <section className="technique">
            <div className="container">

                <h2 className="title_h2">Похожая техника</h2>

                <Slider {...settings} className="technique__slider">
                    {props.similar.filter(item => item.id !== props.isSimilar).map((item, i) =>
                        ...
                        <div key={item.id} className="technique__wrap">
                            <div className="technique__block">
                                ...
                                {item.user.mark === 0 && <div className="rating"> {MarkZero} </div>}
                                ...
                                <div className="content">
                                    ...
                                    <NavLink onClick={window.location.reload} to={`/cart/${item.id}`} className="btn">Подать заявку</NavLink>
                                </div>
                            </div>
                        </div>
