    ...
    return(
        <section className="history_company">
            ...
            <div className="history_company__box">
                ...
                <div className="history_company__content">
                    <p className="text">
                        ПРОРАБ не несет ответственность за результат работы. Услуги через наш сервис предоставляются без посредников, по
                        предоплате (наличный или безналичный расчет). Прием заявок осуществляется круглосуточно, через онлайн форму на сайте. Если у вас возникли вопросы, наши специалисты готовы дать ответ в любое время.
                    </p>
                    <p className="text">
                        Сервис стремится быть лучше и ближе к своим партнерам. Мы имеем положительную репутацию, улучшаем качество своих услуг и стараемся создать максимально комфортные условия, как для заказчиков, так и для исполнителей.
                    </p>
                    <p className="text">
