        ...
        <div className="admin_objects_container">
            <div className="admin_objects_top">
                <form className="admin_objects_search">
                    <input className="admin_objects_search-input" type="text" placeholder="Поиск"></input>
                </form>
                <div className="date">
                    <div>date</div>
                    <div>date</div>
                    ...
                    ? data.map((el) => (
                          <div className="admin_objects_content" key={el.id}>
                              ...
                              {el.status == 0 ? (
                                  ...
                                  <p className="admin_deactive">Деактивировано пользователем</p>
                              ) : (
                                  <p className="admin_delete">Удалено пользователем</p>
                              )}
                              <NavLink to={`${el.id}`}>
                                  <svg
                                      width="20"
